...
export default function Home() {
  ...
  const [columnsToUse, setColumnsToUse] = useState<string>("");
      ...
      <div className="min-h-screen ">
        <div className="0 bg-white px-4 py-5 sm:px-6">
          <div className="-ml-4 -mt-2 flex sm:flex-row flex-col flex-wrap items-center justify-between sm:flex-nowrap">
            <div className="ml-4 mt-2 flex-end ">
        ...
        <div className=" min-h-[90vh] flex flex-col justify-center flex-1">
          <div className="w-full ">
              ...
              <div className="w-full sm:max-w-md">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full rounded-md border-0 bg-white py-4 pl-10 pr-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            ...
            <div className="relative px- mt-4 z-0 flex flex-1 items-center justify-center">
              <div className="w-full sm:max-w-md">
                <label htmlFor="search" className="sr-only">
                  Negative traits
                </label>
                ...
                <div className="w-full sm:max-w-md">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="columnsToUse"
                      value={columnsToUse}
                      onChange={(e) => setColumnsToUse(e.target.value)}
                      className="block w-full rounded-md border-0 bg-white py-4 pl-10 pr-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                      placeholder="Columns to use"
                      type="text"
                    />
                  </div>
                </div>
